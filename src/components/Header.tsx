		...
		<>
			...
			<header className="flex w-[80vw]  justify-between items-center mx-auto mt-10 overflow-x-hidden">
				...
				<motion.nav
					...
					className="flex flex-col md:flex-row md:h-fit md:bg-opacity-0 bg-white p-8 md:p-0 shadow-2xl w-[90vw] md:w-fit left-1/2 -translate-x-1/2 top-20  md:translate-x-0 fixed z-50  md:static md:gap-x-20 items-center gap-y-8 text-center 
				[--opacity-from:0%] 
				[--opacity-to:100%] 
				md:[--opacity-from:100%] 
				md:[--opacity-to:100%]"
